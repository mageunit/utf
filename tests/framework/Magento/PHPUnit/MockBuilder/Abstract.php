...
abstract class Magento_PHPUnit_MockBuilder_Abstract extends PHPUnit_Framework_MockObject_MockBuilder
{
     ...
     * Is needed for PHPUnit 4, because there are all properties "private".
     *
     ...
     */
    protected function _setPrivateValue($property, $value)
    {
        if (!isset(self::$_propertiesCache[$property])) {
            $reflection = new ReflectionClass('PHPUnit_Framework_MockObject_MockBuilder');
            $prop = $reflection->getProperty($property);
            $prop->setAccessible(true);
            self::$_propertiesCache[$property] = $prop;
        }
        self::$_propertiesCache[$property]->setValue($this, $value);
        return $this;
    }
